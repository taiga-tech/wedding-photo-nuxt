<template>
  <v-container>
    <v-card style="max-width: 940px; margin: 0 auto" class="pa-4">
      ...
      <v-card-text>
        <p>
          この利用規約（以下，「本規約」といいます。）は，Wedding Photo
          Album（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>

        <h2 class="mt-5 mb-3">第1条（適用）</h2>
        <ol>
          <li>
        ...
        <h2 class="mt-5 mb-3">第2条（利用登録）</h2>
        <ol>
          <li>
        ...
        <h2 class="mt-5 mb-3">第3条（ユーザーIDおよびパスワードの管理）</h2>
        <ol>
          <li>
        ...
        <h2 class="mt-5 mb-3">第4条（利用料金および支払方法）</h2>
        <ol>
          <li>
        ...
        <h2 class="mt-5 mb-3">第5条（禁止事項）</h2>
        <p>
        ...
        <h2 class="mt-5 mb-3">第6条（本サービスの提供の停止等）</h2>
        <ol>
          <li>
        ...
        <h2 class="mt-5 mb-3">第8条（利用制限および登録抹消）</h2>
        <ol>
          <li>
        ...
        <h2 class="mt-5 mb-3">第9条（退会）</h2>
        <p>
          ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。
        </p>

        <h2 class="mt-5 mb-3">第10条（保証の否認および免責事項）</h2>
        <ol>
          <li>
        ...
        <h2 class="mt-5 mb-3">第11条（サービス内容の変更等）</h2>
        <p>
          当社は，ユーザーに通知することなく，本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし，これによってユーザーに生じた損害について一切の責任を負いません。
        </p>

        <h2 class="mt-5 mb-3">第12条（利用規約の変更）</h2>
        <p>
          当社は，必要と判断した場合には，ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお，本規約の変更後，本サービスの利用を開始した場合には，当該ユーザーは変更後の規約に同意したものとみなします。
        </p>

        <h2 class="mt-5 mb-3">第13条（個人情報の取扱い）</h2>
        <p>
          当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。
        </p>

        <h2 class="mt-5 mb-3">第14条（通知または連絡）</h2>
        <p>
          ユーザーと当社との間の通知または連絡は，当社の定める方法によって行うものとします。当社は,ユーザーから,当社が別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。
        </p>

        <h2 class="mt-5 mb-3">第15条（権利義務の譲渡の禁止）</h2>
        <p>
          ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
        </p>

        <h2 class="mt-5 mb-3">第16条（プライバシーポリシー）</h2>
        <p>
          プライバシーポリシーの詳細は
          <nuxt-link to="/info/privacy/"> プライバシーポリシー </nuxt-link>
          のページをご覧ください。
        </p>

        <h2 class="mt-5 mb-3">第17条（準拠法・裁判管轄）</h2>
        <ol>
